...
## Πολυαριθμητικές συναρτησιακές εξαρτήσεις {#mvd-def}

* Μια πολυαριθμητική συναρτησιακή εξάρτηση: 
  $$ Α_1 Α_2 \ldots A_n \twoheadrightarrow B_1 B_2 \ldots B_m $$ 
  σημαίνει ότι η σχέση περιέχει όλους τους συνδυασμούς των $Α_i$ και $B_j$.
...
* Μία σχέση βρίσκεται στην 4η κανονική μορφή (Fourth Normal Form,
  ...
  πολυαριθμητικές συναρτησιακές εξαρτήσεις $X \twoheadrightarrow Y$,
  το $X$ είναι υπερκλειδί.

## Παράδειγμα παραβίασης 4ης κανονικής μορφής
