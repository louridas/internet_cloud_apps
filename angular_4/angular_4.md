...
* Θα ξεκινήσουμε την κατασκευή του dashboard χρησιμοποιώντας το
  Angular CLI:
    ```bash
...
* Αλλάζουμε το `dashboard.component.ts` ώστε να είναι:
    ```javascript
...
* Θέλουμε επίσης ο χρήστης να μπορεί να πλοηγηθεί στις λεπτομέρειες
  ενός βιβλίου με τρεις τρόπους:
    1. όταν ο χρήστης επιλέγει το βιβλίο από τη λίστα των βιβλίων (όπως τώρα)
    2. όταν ο χρήστης επιλέγει το βιβλίο από τα τέσσερα πρώτα
...
* Τώρα θέλουμε να υλοποιήσουμε τη δυνατότητα όταν ο χρήστης επιλέγει
  ένα βιβλίο από το dashboard να οδηγείται στο εν λόγω βιβλίο.
...
* Ο λόγος είναι ότι θα χρησιμοποιήσουμε τις τρεις αυτές υπηρεσίες στη
  συνέχεια.
...
* Για τη βελτίωση της αισθητικής του dashboard, θα χρησιμοποιήσουμε το
