...
* Θα μαζέψουμε τις διαδρομές (προς το παρόν έχουμε μόνο μία) στο
  αρχείο `app-routing.module.ts`.

* Το αρχείο αυτό θα ορίζει το `AppRoutingModule`:
