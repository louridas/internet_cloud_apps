...
* Στην πραγματικότητα, η `getBooks()` θα καλούσε μια συνάρτηση η οποία
  θα επέστρεφε μια υπόσχεση. 
  
* Η υπόσχεση αυτή θα πραγματοποιούνταν όταν θα ολοκληρωνόταν η
  επικοινωνία με τη βάση δεδομένων ή τον εξυπηρετητή που έχει τα
  στοιχεία για τα βιβλία.
